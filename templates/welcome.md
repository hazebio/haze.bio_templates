    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #141414; border-radius: 16px; border: 1px solid rgba(255, 255, 255, 0.1); overflow: hidden; margin-top: 20px; margin-bottom: 20px;">
        ...
        <div style="padding: 30px 25px;">
            ...
            <div style="background-color: rgba(59, 130, 246, 0.05); border-radius: 12px; padding: 20px; margin-bottom: 24px; border: 1px solid rgba(59, 130, 246, 0.1);">
                ...
                <div style="margin-bottom: 16px;">
                    <p style="margin: 0 0 8px 0; font-size: 14px; color: #d0d0d0; font-weight: 500;">1. Complete Your Profile</p>
                ...
                <div style="margin-bottom: 16px;">
                    <p style="margin: 0 0 8px 0; font-size: 14px; color: #d0d0d0; font-weight: 500;">2. Explore Features</p>
                    <p style="margin: 0; font-size: 14px; color: #a0a0a0; line-height: 1.5;">
                ...
                <div>
                    <p style="margin: 0 0 8px 0; font-size: 14px; color: #d0d0d0; font-weight: 500;">3. Join Our Community</p>
                    <p style="margin: 0; font-size: 14px; color: #a0a0a0; line-height: 1.5;">
                        Connect with other users and join our <a href="https://discord.gg/hazebio" style="color: #3b82f6; text-decoration: none;">Discord community</a> to stay updated and get support.
                    </p>
                </div>
            </div>
            
            <div style="text-align: center; margin-bottom: 30px; padding: 20px; background-color: rgba(0, 0, 0, 0.2); border-radius: 12px;">
            ...
            <p style="color: #a0a0a0; font-size: 14px; line-height: 1.6; margin-bottom: 0;">
                If you have any questions, our support team is here to help. Feel free to reach out at <a href="mailto:help@haze.bio" style="color: #3b82f6; text-decoration: none;">help@haze.bio</a>.
            </p>
        </div>
        ...
        <div style="background-color: rgba(0, 0, 0, 0.2); padding: 20px; text-align: center; border-top: 1px solid rgba(255, 255, 255, 0.05);">
            <p style="margin: 0 0 12px 0; color: #707070; font-size: 14px;">
                Thank you for supporting haze.bio!
            </p>
            <div style="margin: 16px 0;">
                <a href="https://discord.gg/hazebio" style="display: inline-block; margin: 0 8px; color: #707070; text-decoration: none; font-size: 13px;">Discord</a>
