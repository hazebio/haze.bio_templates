...
<head>
    ...
    <title>Thank You for Your Purchase | haze.bio</title>
</head>
<body style="margin: 0; padding: 0; background-color: #0f0f0f; color: #e0e0e0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #141414; border-radius: 16px; border: 1px solid rgba(255, 255, 255, 0.1); overflow: hidden; margin-top: 20px; margin-bottom: 20px;">
        <div style="background-color: rgba(16, 185, 129, 0.1); padding: 20px; text-align: center; border-bottom: 1px solid rgba(255, 255, 255, 0.05);">
            ...
            <h1 style="margin: 0; color: white; font-size: 24px; font-weight: 600;">Thank You for Your Purchase!</h1>
        </div>
        
        <div style="padding: 30px 25px;">
            <p style="color: #b0b0b0; font-size: 16px; line-height: 1.6; margin-bottom: 24px;">
                Thanks for your recent purchase from haze.bio. We're excited to have you enjoy our premium features and appreciate your support!
            </p>
            ...
            <div style="background-color: rgba(0, 0, 0, 0.3); border-radius: 12px; padding: 20px; margin-bottom: 24px; border: 1px solid rgba(255, 255, 255, 0.05);">
                ...
                <div>
                    ...
                    <p style="margin: 0; letter-spacing: 2px; font-weight: 600; font-family: 'Courier New', monospace; font-size: 18px; color: #10B981; text-align: center; background-color: rgba(16, 185, 129, 0.1); padding: 12px; border-radius: 6px; border: 1px solid rgba(16, 185, 129, 0.2);">%RedemptionCode%</p>
                </div>
            </div>
            ...
            <div style="background-color: rgba(16, 185, 129, 0.05); border-radius: 12px; padding: 16px; margin-bottom: 24px; border: 1px solid rgba(16, 185, 129, 0.1);">
                <p style="margin-top: 0; margin-bottom: 12px; font-size: 14px; color: white; font-weight: 500;">How to Redeem Your Code:</p>
                <ol style="margin: 0; padding: 0 0 0 20px; color: #a0a0a0; font-size: 14px; line-height: 1.5;">
                    ...
                    <li style="margin-bottom: 8px;">Go to Account Settings and look for "Redeem Product"</li>
                    <li style="margin-bottom: 0;">Enter your code and enjoy your purchased product</li>
                </ol>
            </div>
            
            <p style="color: #b0b0b0; font-size: 16px; line-height: 1.6; margin-bottom: 24px;">
                If you encounter any issues with your purchase or redemption, please don't hesitate to open a support ticket on Discord or contact our team via email.
            </p>
